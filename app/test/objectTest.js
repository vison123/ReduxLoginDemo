...
/*缺点: 属性共享在操作引用类型的属性时出现问题
*  Person1.prototype.friends = ['Shelby','Count']
*  vison.friends.push('van')
*  该操作会修改所有实例的friends属性
* */
//解决方案: 将类似引用属性放在constructor中,构造函数模式和原型模式混合使用
...
var personA = new Person3('Nicholas', 29, 'SoftWare Engineer');
var personB = new Person3('Greg', 27, 'Doctor');

console.log(personA.friends);
console.log(personB.friends);
personA.friends.push('Vans');
personB.friends.push('Vison');
console.log(personA.friends);
console.log(personB.friends);